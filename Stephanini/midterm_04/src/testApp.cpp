...
void testApp::draw(){
    ...
    for (int i=0; i<5000; i++) {
       ...
       // ofCircle( (ofSignedNoise(i*0.1+x)*100) -400, ofSignedNoise((i+1)*0.1+x)*500, 1);
        ofRect((ofSignedNoise(i*0.1+x)*100), x, ofGetElapsedTimef()*90, ofSignedNoise((i+10)*0.1+x)*0.9);
...
//        ofSetColor(ofRandom(0, 25), ofRandom(0, 60), ofRandom(0, 105));
//        // ofCircle( (ofSignedNoise(i*0.1+x)*100) -400, ofSignedNoise((i+1)*0.1+x)*500, 1);
//        ofRect((ofSignedNoise(i*0.8+x)*100) +100, ofSignedNoise((i+1)*0.1+x)*100, ofGetElapsedTimef()*90, ofGetElapsedTimef()*10);
//    }
//    
//    for (int i=0; i<3000; i++) {
//        ofSetColor(ofRandom(0, 25), ofRandom(0, 60), ofRandom(0, 105));
//        // ofCircle( (ofSignedNoise(i*0.1+x)*100) -400, ofSignedNoise((i+1)*0.1+x)*500, 1);
//        ofRect((ofSignedNoise(i*0.1+x)*900), ofGetElapsedTimef()*90,ofSignedNoise((i+1)*0.1+x)*100, ofSignedNoise((i+10)*0.1+x)*0.9);
//    }
//    
