...
void testApp::setup(){
    ...
    string name = "snaxx & macs aoembaBox";
    ...
    image.loadImage("whiteSpace.png");
    back.loadImage("geometric.gif");
    ...
    myPlayer.loadMovie("geometric.gif");
...
void testApp::draw(){
    ...
    if(motionSensor == true || (motionSensor == false && timer < timeAmount) )  {
        ...
        myPlayer.draw(ofGetWidth()/2-200,ofGetHeight()/2-150);
        ...
        ofColor centerColor = ofColor(25, 25, 25);
