...
//--------------------------------------------------------------
ofMesh testApp::meshSphereTop (ofImage imageA, ofMesh meshTop, vector<ofColor> colors, float radius, float sound){
...
void testApp::draw(){
    ...
    meshTop = meshSphereTop(image, meshT, colors, radius, scaledVol);
    meshTop.draw();
