...
//--------------------------------------------------------------
ofPoint testApp::drawAngleLine(ofPoint center, float angle, float length){
    ofPoint outer;
...
//--------------------------------------------------------------
void testApp::draw(){
    //drawTwoLines( 20, sin(ofGetElapsedTimef()*20)*50, 0, 100, 200);
    ofPoint center;
    center.x = ofGetWidth()/2;
    center.y = ofGetHeight()/2;
    //drawAngleLine(center, 45 + ofGetElapsedTimef(), 100);
    
    //clickBox.setPosition(center);
    ofPoint outerPosition = drawAngleLine(center, 45 + ofGetElapsedTimef()*50, 100);
